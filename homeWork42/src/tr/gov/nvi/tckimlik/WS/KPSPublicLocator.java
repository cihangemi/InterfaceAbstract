...
public class KPSPublicLocator extends org.apache.axis.client.Service implements tr.gov.nvi.tckimlik.WS.KPSPublic {
	...
	public KPSPublicLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName)
	...
	public tr.gov.nvi.tckimlik.WS.KPSPublicSoap getKPSPublicSoap(java.net.URL portAddress)
			throws javax.xml.rpc.ServiceException {
		try {
			tr.gov.nvi.tckimlik.WS.KPSPublicSoapStub _stub = new tr.gov.nvi.tckimlik.WS.KPSPublicSoapStub(portAddress,
					this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
		try {
			if (tr.gov.nvi.tckimlik.WS.KPSPublicSoap.class.isAssignableFrom(serviceEndpointInterface)) {
				tr.gov.nvi.tckimlik.WS.KPSPublicSoapStub _stub = new tr.gov.nvi.tckimlik.WS.KPSPublicSoapStub(
						new java.net.URL(KPSPublicSoap_address), this);
				_stub.setPortName(getKPSPublicSoapWSDDServiceName());
				return _stub;
			}
